...
import UserProfileForm, { UserFormData } from "@/forms/user-profile-form/user-profile-form";
...
const CheckoutButton = ({
  ...
  if (!isAuthenticated) {
    return (
      <Button className="bg-orange-500 flex-1" onClick={onLogin}>Log in to checkout</Button>
    )
  }
